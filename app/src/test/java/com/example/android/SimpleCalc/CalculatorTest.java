...
public class CalculatorTest {
    ...
    @Test
    public void powTwoPositiveIntegers() {
    ...
    public void powSecondNegativeInteger() {
        double resultPow = mCalculator.pow(10,-2);
        assertThat(resultPow, is(equalTo(0.01d)));
    }

    @Test
    public void powFirstZeroSecondPositiveInteger() {
